...
@Entity
@Table(name = "users")
public class UsersEntity extends BaseTimeEntity implements UserDetails {
    @Id
    ...
    @OneToOne(mappedBy = "user", cascade = CascadeType.ALL)
    private UserBaseballEntity baseball;



    public UsersEntity(String subject, String s, Collection<? extends GrantedAuthority> authorities) {
        super();
